...
const About = () => {
  return (
    <>
      <div className=" max-sm:min-h-[100vh] max-sm:justify-center relative  w-full min-h-[100vh]  flex max-sm:flex-col justify-around items-center   bg-[#1C1E27]">
        <div
          id="about"
          className="max-sm:mt-[25px]    w-[100%] max-sm:h-[50vh] h-[50vh] flex flex-col  justify-center items-center"
        >
