...
const About = () => {
  return (
    <>
      <div className="    w-full min-h-[60vh]  relative  flex max-sm:flex-col justify-around items-center   bg-[#1C1E27]">
        <div
          id="about"
        ...
        <div className="   max-sm:w-[100%] max-sm:h-[40vh]  max-sm:px-5 max-sm:items-center relative  flex flex-col justify-center items-start  w-[100%]  h-[90vh]   rounded-xl">
          <div className=" max-sm:w-[100%]  max-sm:mt-5 glass-background card-glow-yellow px-10 rounded-3xl py-5 w-[80%]">
